...
-   trying to generate some basic distance correlation matrices for miRNA-mRNA pairs (in E5 dde), but getting stuck actually accessing a distance correlation calculation! Can't install any of the correlation statistic R packages I've tried (energy, distcor, etc.). Will need to make a github issue.

-   SWED101 class

-   [Weekly meeting with Steven](./2024_10_31_weekly_steven_meeting.qmd), including preliminary discussion of committee meeting requirements and planning for tomorrow's E5 meeting

-   troubleshooting the [Raven package installation issues](https://github.com/RobertsLab/resources/issues/2000) with Sam -- seems to be related to Raven having an outdated version of GSL.
...
-   poked around Sam's lab notebook and github issues for the CEABIGR offspring methylation data Steven and I discussed last Friday -- think I found it [here](https://github.com/RobertsLab/resources/issues/1517) and [here](https://github.com/RobertsLab/resources/issues/1961) (note: CEABIGR offspring appear to be called CEASMALLR -- cute!)
