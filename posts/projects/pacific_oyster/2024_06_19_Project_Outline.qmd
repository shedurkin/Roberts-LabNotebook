...
-   Say manual hardening 3-4 hrs/day MWF. Then 2 wk recovery and MHW of 40C immersed and emmersed for a few hours, then montier at ambient for a few weeks. Can stress test rest if alive.

-   Also, can include a much larger number of diploids and outplant MHW survivors to test long term effects

-   could throw in the tetraploids to spawn at the end and see if larvae are more resilient

-   We need to grab 4 cohorts that havent been tested yet (can see github issue about ploidy stuff)
